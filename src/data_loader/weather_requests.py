...
class HistoryWeatherRequestTomorrow(HistoryWeatherRequestBase):
    def __init__(self):
        super().__init__()
        self.base_url = "https://api.tomorrow.io/v4/historical"
        self.api_key = settings.TOMORROW_API.key
    ...
    def get_query_params(self):
        return {
            ...
            "timesteps": "1h",
            "startTime": self.startDateTime["ISO 8601"],
            "endTime": self.endDateTime["ISO 8601"],
            "apikey": self.api_key,
            "units": "metric"
        }
